...
abstract class BaseBloc {
  ...
  final StreamController<int> _loadingIntController = BehaviorSubject();
  ...
  Stream<int> get loadingStreamInt => _loadingIntController.stream;
  Sink<int> get loadingSinkInt => _loadingIntController.sink;
